...
public interface LocalityRepository extends CrudRepository<Locality, Integer> {
    ...
    String FIND_BY_LOCALITY_NAME_AND_STATE_AND_POSTCODE_QUERY = "SELECT l FROM Locality l "
            + "WHERE l.localityName = :localityName AND l.state = :state AND l.postcode = :postcode";
    ...
    List<Locality> findByLocalityNameAndStateAndPostcode(@Param("localityName") String localityName, @Param("state") String state,
